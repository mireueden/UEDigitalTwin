...
DECLARE_STATS_GROUP(TEXT("TwinManager"), STATGROUP_TwinManager, STATCAT_Advanced);
DECLARE_CYCLE_STAT(TEXT("InteractionComponent_Add"), STAT_InteractionComponentAdd, STATGROUP_TwinManager);
DECLARE_CYCLE_STAT(TEXT("InteractionComponent_Remove"), STAT_InteractionComponentRemove, STATGROUP_TwinManager);
DECLARE_CYCLE_STAT(TEXT("InteractionTargetChange"), STAT_InteractionTargetChange, STATGROUP_TwinManager);
...
{
	SCOPE_CYCLE_COUNTER(STAT_InteractionComponentAdd);
...
{
	SCOPE_CYCLE_COUNTER(STAT_InteractionComponentRemove);
...
{
	SCOPE_CYCLE_COUNTER(STAT_InteractionTargetChange);
